...
PLANTS_NEARBORN_CHANCES = 150 #A1
PLANTS_RANDOM_DIE_CHANCES = 2 # not used
PLANTS_ENERGY_BASE_PER_CYCLE = 100 #A2
...
SPECIE1_NEARBORN_CHANCES = 25 #A3
...
SPECIE1_ENERGY_NEEDED_PER_CYCLE = 50 #A5
...
SPECIE1_MAX_ENERGY_RECOLECTED_PER_CYCLE = 100 #A6
...
SPECIE2_NEARBORN_CHANCES = 30 #A8
SPECIE2_RANDOM_DIE_CHANCES = 2 # not used
SPECIE2_ENERGY_BASE = 250 # not used
SPECIE2_ENERGY_NEEDED_PER_CYCLE = 50 #A9
SPECIE2_MAX_ENERGY_RECOLECTED_PER_CYCLE = 100 #A10
