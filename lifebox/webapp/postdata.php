<?php
  ...
  if ($_POST['amount-sp1-4']=="undefined") $_POST['amount-sp1-4']=0;
  if ($_POST['amount-sp2-4']=="undefined") $_POST['amount-sp2-4']=0;
  if ($_POST['amount-sp3-4']=="undefined") $_POST['amount-sp3-4']=0;
